...
<html lang="pt-br">
	<head>
        ...
        //https://www.drssistemas.com.br
	        ...
	        {
	            {              
					location='http://www.drssistemas.com.br/menu/abertura_nitoli.htm' ;
	            }
	        }
	    </script>
	    <title>Formulário Movimentação de Pessoal - MP - REV.: 00</title>
		<style type="text/css">
			*{padding:0;margin:0;font-family:calibri,sans-serif;font-size:12px}
			body{
			...
			<form name='FRM_MP'>
				<tr>
					<td colspan='1' rowspan='1'>
						<p>
							...
							<!-- 
							<left>
							<button style="background-color: green; border-color: blue; color:white">
							</button>	
							...
							<button style="background-color: green; border-color: blue; color:white" onclick="abertura2()" > VOLTAR AO MENU </button>
							-->
							<h3><center><a href="../../menu/abertura_nitoli.htm" 
					...
					<td colspan='1' rowspan='1'>
						<center><img align="center" src="/Imagens e Logos/Imagens/logo-nitoli.jpg" width="130px" height="29px"/></center>
					</td>
				</tr></br>
				<tr>
							...
							<p></br>
								...
								<select name="area1" id="iarea1">
									...
									<optgroup label="FÁBRICA">
										<option value="IMP">Impressão</option>
										<option value="C/V">Corte / Vinco</option>
										<option value="GUI">Guilhotina</option>
										<option value="COL">Coladeira</option>
										<option value="QUA">Setor Qualidade</option>
										<option value="ACB">Acabamento</option>
										<option value="EXP">Expedição</option>
										<option value="ATL">Ateliê</option>
									</optgroup>
								</select>
							</p>
						</form>		
				...
				<tr>
					...
					<td colspan='2' rowspan='1'>
						<form>
							<p>
								<i><b>DISPONIBILID. PARA VIAGENS:</b></i>
				...
				<tr>
					<td colspan='1' rowspan='1'>
						<form>
							<p>
								<i><b>
								<label for="iarea3">DE ÁREA</label>
								</b></i>
								</br>
						...
						<form>
							<p>
								...
								<select name="c_c1" id="ic_c1">
									<optgroup label="CENTROS CUSTO NITOLI">
										<option value="VAZ"> </option>	
										<option value="CML">Comercial</option>
										<option value="CMP">Compras</option>
										<option value="RHU">Recursos Humanos</option>
					...
					<td colspan='1' rowspan='1'>
						<form>
							<p>
								<i><b>
								<label for="iarea4">PARA ÁREA</label>
								</b></i>
								</br>
							...
							<p>
								<h4>
									...
									<left>										
										...
										<br>
										                    <input type="text" maxlength="50" id="responsavel" name="nome_responsavel"/>
									</left>
								</h4>
								<h3>
									<left>
						...
						<form>
							<p>
								<h4>
									...
									<center>DIRETORIA DA ÁREA</center>
									<label for="diretoria"></label>
									<center><input type="text" maxlength="50" id="diretoria" name="nome_diretoria"/></center>
								</h4>
							</p>
							<form name='abertura'>
								<center><input type='button' value='VOLTAR AO MENU DE CADASTRO' onClick='abertura2(this.form)'></center>
					...
					<td colspan='2' rowspan='1'>
						<p>
							<h4>
								...
								<center>GERÊNCIA RECURSOS HUMANOS</center>
								<label for="recursos_humanos"></label>
								<center><input type="text" maxlength="50" id="rh" name="nome_rh"/></center>
							</h4>
						</p>
						<label for="lbl_branco"> </label>
					</td>
				</tr>
			</form>
		</table>
	</div>
	<center><button onclick="downloadPDF()" >  GERAR PDF  </button></center>

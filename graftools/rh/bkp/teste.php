...
<html lang="pt-br">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="teste_estilos_.css" />
	...
	<body>
		<div class="Content">
			<center>
			<table class="tabela_mp" width="300px" cellspacing="1" cellpadding='1' border='2'>
				<form name='FRM_MP'>
					<tr>
						<td colspan='1' rowspan='1'>
							<p>
								<h3><a href="../../menu/abertura_graftools.htm" 
                            	rel="next">VOLTAR AO MENU DE CADASTRO</a></h3>
							</p>
						</td>
						<td colspan='1' rowspan='1'>
							<p>
						...
						<td colspan='1' rowspan='1'>
							<h3> MOVIMENTAÇÃO PESSOAL </h3>
						</td>
						<td colspan='1' rowspan='1'>
							<img src="/Imagens e Logos/Imagens/LOGO6_DRS.jpg" width="130px" height="29px"/>
						</td>
					</tr></br>
					<tr>
		...
		<center><button onclick="downloadPDF()" >  GERAR ARQUIVO PDF  </button></center>

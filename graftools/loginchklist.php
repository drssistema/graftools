...
<head>
  ...
  <script>
    function gerasenhachklist() { location = 'graftools/geracriptochklist.php'; }
    function paginainicial() { location = '../index.html'; }
    function telaloginchklist() { location = 'graftools/loginchklist.php'; }
  ...
  <div class="login-box">
    ...
    <form method="POST" action="validachklist.php">
      ...
      <div class="btn-actions">
        <input type="submit" name="btnLoginchklist" class="acessar" value="Acessar" />

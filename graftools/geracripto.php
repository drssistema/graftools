...
<head>
    ...
    <title> *** DRS Sistemas - Login  ***</title>
    <style>
		table
			{
				align-self: center;
    ...
    <center><table cellspacing="3" cellpadding='0' border='2'>
        ...
        <tr>
            <td colspan="1" class="minusculo">
                <form name="abertura" method="POST" action="valida_cripto.php"> 
                    <h3>
                        <p>
                            <center>
                            <!-- 
                   ...
                   // <input type="text" id="usu_login" name="usu_login" style="text-transform: lowercase;" placeholder="digite o seu  login...> 
		                    ...
		                    <input class="cor_btn" type="submit" name="btnLogin" value="Gerar Senha" style="background-color: aquamarine;">
                            <input type='Reset' value='Limpar Campos' style="background-color: antiquewhite;">
                            <input type='button' value='Voltar p/ Tela Login' onClick='telalogin(this.form)' target="_blank" style="background-color: yellow;">
                            </center></h2><br>
                            <center>
                            <h5><mark>
                            <a href="https://www.drssistemas.com.br/graftools/geracripto.php" rel="external">ATUALIZAR !</a>
                            </mark></h5>
                            </center>
                        </p>
                    </h3>
